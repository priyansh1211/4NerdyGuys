            ...
            children: [
              ...
              ListView(
                children: [
                  Column(
                    children: [
                      Container( //MediaQuery.of(context).size.width * 0.9111,
                            ...
                            DropdownButton2(
                              ...
                              onChanged: (String? newValue) {
                                setState(() {
                                  ...
                                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => SecondProjectBlocks(index: newblocks,projectName: dropdownvalue,email: widget.name.toString(),)));
                                });
                              },
                            ),
