                        ...
                        if(snapshot.hasData)
                          {
                            ...
                            for(int i=0;i<snapshot.data!.length;i++)
                              {
                                if(snapshot.data![i]["item_name"].toString().toLowerCase().contains(search.toLowerCase()) || snapshot.data![i]["item_code"].toString().toLowerCase().contains(search.toLowerCase()) )
                                  {
                                      ...
                                      child: Card(
                                        ...
                                        child: Stack(
                                          children: [
                                            ...
                                            Padding(padding: const EdgeInsets.only(left: 20,bottom: 15),
                                              child: Align(
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) => ItemDetailPage(
                                                    ...
                                                    cont: temp[index]["item_name"]
                                                        .toString(),code : temp[index]["item_code"]
                                                    .toString())));
                                      },
                                    ),
