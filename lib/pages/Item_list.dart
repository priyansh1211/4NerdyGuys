                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          onTap: (){
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context)=> Additem(projectName: widget.projectName.toString(),)));
                          },
                        ),
                      ],
                    ),
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    left: 20,
                                    child: Text(
                                      snapshot.data![index]["item_code"].toString(),
                                      style:
                                      const TextStyle(fontSize: 15, fontFamily: 'ReadexPro'),
                                    ),
                                  ),
                                  Positioned(
