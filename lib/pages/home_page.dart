...
import 'package:flutter_app/pages/ownerview.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  @override
  void initState() {
    initial1().then(updateName);
    initial2().then(updateDesignation);
    super.initState();
  }

  Future<String> initial1() async {
    SharedPreferences? preferences = await SharedPreferences.getInstance();
    name = preferences.getString("UserName")!;
    return name;
  }

  Future<bool> initial2() async {
    SharedPreferences? preferences = await SharedPreferences.getInstance();
        ...
        child: Stack(
          ...
          children: [
            ...
            Positioned(
              ...
              child: Text(
                name.split(' ').elementAt(0).toString(),
                            ...
                            child: Stack(
                              children: [
                                Container(
                                  ...
                                  child: Center(
                                    child:
                                        Image.asset('assets/images/proj.png'),
                                  ),
                                ),
                                Align(
                                  ...
                                  child: Container(
                                    margin:
                                        const EdgeInsets.only(bottom: 10.42),
                                    width: MediaQuery.of(context).size.width *
                                        0.3653055555555556,
