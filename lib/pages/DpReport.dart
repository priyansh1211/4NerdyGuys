...
import 'package:flutter_app/pages/Reports/DesignRequirement.dart';
import 'package:flutter_app/pages/Reports/MachineryReport.dart';
import 'package:flutter_app/pages/Reports/MaterialReport.dart';
import 'package:flutter_app/pages/Reports/NextDayPlanning.dart';
...
class DpReportPage extends StatefulWidget {
  ...
  const DpReportPage({Key? key, required this.pName, required this.prog})
      : super(key: key);
                    ...
                    InkWell(
                      ...
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const MaterialReport()));
                      },
                    ),
                  ],
                ),
                    ...
                    InkWell(
                      ...
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const NextDayPlanning()));
                      },
                    ),
                  ],
                ),
